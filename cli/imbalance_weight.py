...
def get_file_pairs(images_dir, masks_dir):
    image_files = set(f for f in os.listdir(images_dir) if f.lower().endswith(('.png', '.jpg')))
    mask_files = set(f for f in os.listdir(masks_dir) if f.lower().endswith(('.png', '.jpg')))
...
if __name__ == "__main__":
    ...
    masks_dir = os.path.join("..","data", "annotated data", "all_in_one")
